...
var xxx=null;
if(x=="1"){xxx="http://apk-safelink.blogspot.co.id/2018/03/image-to-word-document-scanner-with-ocr.html"}
if(x=="2"){xxx="http://apk-safelink.blogspot.co.id/2018/03/camscanner-phone-pdf-creator.html"}
if(x=="3"){xxx="http://apk-safelink.blogspot.co.id/2018/03/photodirector-photo-editor-app.html"}
if(x=="4"){xxx="https://apk-safelink.blogspot.com/2018/03/photo-lab-picture-editor-face-effects.html"}
if(x=="5"){xxx="http://apk-safelink.blogspot.co.id/2018/03/bolla-tournament-bracket-maker.html"}a_to_ve[i].href="https://apk-safelink.blogspot.com/"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
